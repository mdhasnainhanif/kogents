        ...
        <>
            ...
            <Counter
                ...
                labels={{
                    ...
                    supportTickets: "Cost savings",
                    resolutionRate: "Events optimized",
                    roi: "Faster scheduling",
                }}
                units={{
                    responseTime: "%",
                    supportTickets: "%",
            ...
            <CustomerGrowthCards
                ...
                description="Event planning requires more than coordination. It needs accuracy, adaptability, and personalization at every step. Our AI agent event planner delivers solutions designed to simplify complex workflows and support organizers with intelligent automation.Here’s what we deliver"
                solutions={[
                    {
                        id: 1,
            ...
            <CustomerServiceCard
                ...
                description="Our AI agent event planner is designed to deliver reliability, adaptability, and professional-grade results across every stage of event management."
                differentiators={[
                    {
                        id: 1,
            ...
            <FaqWithImage
                ...
                description="Event planning demands structure and reliability at every stage. Our process ensures that each step is clear, consistent, and backed by intelligent automation.Here's how it works:"
                faqItems={[
                    {
                        id: 1,
                        ...
                        image: "/assets/img/faq/event-step1.png",
                    },
                    {
                        id: 2,
                        q: "Deploy AI Agent",
                        ...
                        image: "/assets/img/faq/event-step2.png",
                    },
                    {
                        id: 3,
                        q: "Train & Integrate",
                        ...
                        image: "/assets/img/faq/event-step3.png",
                    },
                    {
                        id: 4,
                        q: "Optimize & Scale",
                        ...
                        image: "/assets/img/faq/event-step4.png",
                    }
                ]}
