    ...
    return (
        <>
            ...
            <CustomerCards
                ...
                description="Traditional event planning drains time, budgets, and focus through repetitive tasks and manual oversight. By introducing automation and intelligence, an AI agent event planner allows organizers to shift attention from operations to strategy.Here’s how it helps:"
                benefits={[
                    {
                        id: 1,
            ...
            <CustomerServiceCard
                ...
                differentiators={[
                    ...
                    },
                    {
                        ...
                        description:
                            "Teaching can be overwhelming with all of the paperwork, lesson planning, and grading. \n By utilizing technologies that are specifically designed to simplify and expedite daily tasks, teachers are able to concentrate on the most important aspects of their work.",
                    },
                    {
                        id: 3,
                        icon: "/assets/img/icons/17.svg",
                    ...
                    },
                    {
                        ...
                        description:
                            "Time and energy that could be better spent engaging with students are drained by redundancy.\n The assistant takes care of the boring, monotonous duties behind the scenes so that teachers can focus on making the lessons fun and creative.",
                    },
                ]}
            />
            <AwardSection />
                ...
                faqItems={[
                    {
                        ...
                        image: "/assets/img/faq/teacher-step1.png",
                    },
                    {
                        id: 2,
                        ...
                        image: "/assets/img/faq/teacher-step2.png",
                    },
                    {
                        id: 3,
                        ...
                        image: "/assets/img/faq/teacher-step3.png",
                    },
                    {
                        id: 4,
                        ...
                        image: "/assets/img/faq/teacher-step4.png",
                    },
                    {
                        id: 5,
                        ...
                        image: "/assets/img/faq/teacher-step5.png",
                    }
                ]}
