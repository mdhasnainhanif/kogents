      ...
      <CustomerServiceCard
        ...
        differentiators={[
          ...
          },
          {
            ...
            description:
              "Using advanced AI and medical knowledge bases, Kogents ensures every patient interaction is context-driven, accurate, and aligned with medical protocols. Seamless EHR integration provides real-time patient data access.",
          },
          {
            id: 3,
            icon: "/assets/img/icons/17.svg",
      ...
      <CustomerServiceFaqSection
        ...
        faqItems={[
          ...
          },
          {
            ...
            a: "AI optimizes resource allocation, automates billing and claims, reduces paperwork, and supports compliance with healthcare regulations.",
          },
          {
