...
export const metadata: Metadata = {
    title: 'Kogents AI Teacher Assistant | The Future of Teaching',
    description:
        'Kogents AI teacher assistant is your classroom ally, which lets you save time, reduce stress, and discover new ways to teach with powerful AI support.',
    keywords: [],
    ...
    openGraph: {
        ...
        description:
            'Kogents AI teacher assistant is your classroom ally, which lets you save time, reduce stress, and discover new ways to teach with powerful AI support.',
        url: 'https://www.kogents.ai/solutions/ai-teacher-assistant', // replace with actual page URL
        type: 'website',
        images: [
            {
    ...
    return (
        <>
            ...
            <CustomerCards
                ...
                description={`An AI teaching assistant does things like score multiple-choice tests and keep track of how well students are doing. \n \n This lets teachers give more detailed feedback and lead discussions. \n \n Here's why an AI teacher assistant is needed to help with burnout and heavy workloads.`}
                benefits={[
                    {
                        id: 1,
                        ...
                        description:
                            "To make differentiated lesson plans and practice activities, a smart teaching assistant can do the work in minutes instead of hours. \n This leaves you with more time for creativity and student engagement.",
                    },
                    {
                        id: 2,
                        ...
                        description:
                            "An AI grading assistant quickly grades objective tests and points out skill gaps, which lets teachers focus on more extensive instruction. \n This immediate feedback helps in improving your student performance while shortening assessment time",
                    },
                    {
                        id: 3,
                        ...
                        description:
                            "Handing over repetitive tasks and planning work to a classroom assistant helps to lighten the load and reduce stress. \n This way, teachers regain energy to mentor and connect with their students.",
                    },
                    {
                        id: 4,
                        ...
                        description:
                            "Using AI tutoring agents to automate scheduling, tracking attendance, and keeping track of student progress cuts down on administrative work that needs to be done. \n Because of this, teachers can focus on the class instead of the paperwork.",
                    },
                ]}
            />
            ...
            <CustomerGrowthCards
                ...
                solutions={[
                    ...
                    },
                    {
                        ...
                        description:
                            "When a dependable teaching assistant manages the behind-the-scenes tasks, teachers can remain fully engaged in the classroom, provide greater attention to their students, and concentrate on what matters most.",
                    },
                    {
                        id: 4,
                        iconColor: "bg-teal-500",
                ...
                differentiators={[
                    {
                        ...
                        description: [
                            "It shouldn't feel like extra work to share resources, lesson plans, and student progress.",
                            "",
                            "Our classroom AI assistant supports teamwork by keeping everyone on the same page and making sure teachers can work together without any extra stress."
                        ]
                    },
                    {
                        id: 2,
                    ...
                    },
                    {
                        ...
                        description:
                            "The intelligent AI teacher assistant is a game changing innovation for class room tasks because it helps with lesson organization, progress tracking, and reporting while maintaining consistency and minimizing errors, giving teachers peace of mind.",
                    },
                    {
                        id: 4,
                ...
                faqItems={[
                    {
                        ...
                        a: "You should begin by outlining your goals for the class, including particular skills you hope your students will acquire and the specific results you hope to see. \n The AI tutoring agent bases all the next steps on these objectives.",
                        image: "/assets/img/ai-teacher-assistant/define-teaching-goals.webp",
                    },
                    {
                        id: 2,
                        q: "Organize Lesson Materials",
                        a: "Select or upload your teaching resources, slides, notes, activities, or references. \n The assistant organizes them into a structured library, ensuring that they are easily accessible when required.",
                        image: "/assets/img/ai-teacher-assistant/organize-lesson-materials.webp",
                    },
                    {
                        id: 3,
                        q: "Create Lesson Outlines",
                        a: "With objectives and resources in place, the assistant creates lesson outlines that progress in an orderly way. \n It provides you with a clear roadmap while leaving room for your own personal touch by suggesting activities, pacing, and checkpoints.",
                        image: "/assets/img/ai-teacher-assistant/create-lesson-outlines.webp",
                    },
                    {
                        id: 4,
                        q: "Automate Grading and Feedback",
                        a: "After lessons, the assistant evaluates tests and gives feedback on objective tasks quickly. \n This way, students get answers quickly, and teachers don't have to spend hours marking the same things over and over again.",
                        image: "/assets/img/ai-teacher-assistant/automate-grading-and-feedback.webp",
                    },
                    {
                        id: 5,
                        q: "Track Progress and Improve",
                        a: "Finally, the assistant gathers performance data, highlighting student strengths and areas where additional support is required. \n With this information, you can improve future lessons and keep every student progressing forward.",
