        ...
        benefits={[
          {
            ...
            description:
              "A generative AI marketing agent makes pitches better, adjusts the schedule, and improves content in real time to make sure that campaigns reach the right people at the right time and get better results.This ensures maximum impact from every marketing dollar spent.",
          },
          {
            id: 2,
          ...
          },
          {
            ...
            description:
              "An AI marketing assistant helps you get more out of your campaigns without breaking the bank. \n The agent boosts engagement and impact across channels, making campaigns successful without extra expenses.",
          },
        ]}
      />
        ...
        differentiators={[
          {
            ...
            description: ["Our autonomous marketing assistants aren’t just automated scripts; they’re like dedicated virtual team members backed by advanced data analysis. \n They go beyond basic automation by learning from every campaign, managing complex multi-step tasks, and adjusting strategies as things change.", "This smart adaptability keeps your marketing in sync with what really works, leading to better results."],
          },
          {
            id: 2,
          ...
          },
          {
            ...
            description: [
              "Rapid response is essential in today's market. \n Our AI-powered marketing agent keeps an eye on real-time data streams across various channels and adjusts campaigns in real-time.", "Think of it as your go-to analyst that’s always on the job, bringing you insights and opportunities in real-time. \n This way, you can start and improve your campaigns without having to wait for next week’s report."
            ],
          },
          {
            id: 5,
            ...
            description: [
              "Let data help you make decisions, but don’t let it stress you out. \n Our analytics engine takes complicated data and turns it into straightforward, useful insights.", "It helps your team quickly spot the best creatives, segments, and channels, so they can make smart, confident choices that lead to growth."
            ],
          },
        ]}
      />
