...
export const metadata: Metadata = {
    title: 'Kogents AI Agent Dashboard | Advanced Monitoring Solutions',
    description:
        'The Kogents AI agent dashboard gives you real-time power and intelligent monitoring to lead with clarity, accuracy, and confidence every day.',
    keywords: [],
    ...
    openGraph: {
        ...
        description:
            'The Kogents AI agent dashboard gives you real-time power and intelligent monitoring to lead with clarity, accuracy, and confidence every day.',
        url: 'https://www.kogents.ai/solutions/ai-agent-dashboard', // replace with actual page URL
        type: 'website',
        images: [
            {
    ...
    return (
        <>
            ...
            <CustomerCards
                ...
                description={`The AI agent analytics dashboard transform raw data into clear insights in seconds gives businesses a clear view of all the information they need to keep track of to perform and make decisions that influence the results. \n \n Here's why an AI agent dashboard is crucial for navigating through overwhelming data effectively.`}
                showButton={true}
                ...
                benefits={[
                    {
                        ...
                        description:
                            "With powerful AI agent monitoring, you get instant visibility into the metrics that matter most, with no delays or blind spots.\n \n Real-time insights allow you to identify problems early, act quickly, and stay ahead of the curve.",
                    },
                    {
                        id: 2,
                        ...
                        description:
                            "The agentic analytics dashboard makes things that are hard to understand clear, giving your team easy-to-understand information they can use right away. \n \nNo more wasting time looking for numbers; you can get useful information right away.",
                    },
                    {
                        id: 3,
                        ...
                        description:
                            "The dashboard agents make sure that every report is accurate, which cuts down on mistakes and increases trust in your decisions.\n Your team can move forward with confidence, knowing that every decision is based on factual information.",
                    },
                    {
                        id: 4,
                        ...
                        description:
                            "The AI agent dashboard guarantees timely updates, streamlines processes, and automates tracking.\n It ensures that your business runs smoothly daily by eliminating obstacles and optimizing routine monitoring.",
                    },
                ]}
            />
            ...
            <CustomerGrowthCards
                ...
                solutions={[
                    ...
                    },
                    {
                        ...
                        description:
                            "Your real-time AI agent dashboard is your go-to spot for all the info you need. It brings together data from different processes, helps everyone stay on the same page, and makes sure decisions are based on the same insights.",
                    },
                    {
                        id: 5,
                        iconColor: "bg-teal-500",
            ...
            <FaqWithImage
                ...
                faqItems={[
                    ...
                    },
                    {
                        id: 2,
                        q: "Connect Data",
                        a: "After that, the AI dashboard compiles data from all the sources you use. It gathers all of your data into a single location, saving you the trouble of managing multiple systems and reports. That way, everyone on the team is working from the most current, accurate information.",
            ...
            <CustomerServiceFaqSection
                ...
                faqItems={[
                    ...
                    },
                    {
                        ...
                        a: "Intelligent AI agent dashboards centralize performance and workflow data into one real-time view, keeping everyone aligned, reducing misunderstandings, and enabling faster, unified decision-making."
                    }
                ]}
