...
export const metadata: Metadata = {
  title: 'AI Agent for HR to Automate Workforce Management | Kogents',
  description:
    'Deploy smarter HR automation. Kogents AI Agent for HR delivers accurate, efficient, and compliant workflows for modern HR teams.',
  keywords: [],
  ...
  openGraph: {
    ...
    description:
      'Deploy smarter HR automation. Kogents AI Agent for HR delivers accurate, efficient, and compliant workflows for modern HR teams.',
    url: 'https://www.kogents.ai/solutions/ai-agent-for-hr', // replace with actual page URL
    type: 'website',
    images: [
      {
  ...
  return (
    <>
      ...
      <CustomerCards
        ...
        description="HR leaders face constant pressure from hiring delays, compliance demands, and administrative overload. Modern HR tech supported by automation helps address these challenges directly. Key areas of impact include:"
        benefits={[
          {
            id: 1,
            ...
            description:
              "Routine tasks like leave requests and policy questions drain HR resources. \n With workforce automation and employee self-service AI, teams cut manual work and redirect focus toward strategy and employee growth.",
          },
          {
            id: 2,
            ...
            description:
              "Delays in hiring cost time and talent. \n Talent acquisition software and recruiting automation streamline screening, reduce bias, and accelerate decision-making. \n McKinsey's workforce research shows AI-driven recruiting shortens cycles and improves candidate quality.",
          },
          {
            id: 3,
            ...
            description:
              "Employment law complexity makes errors costly. \n HR compliance automation supports accurate documentation and reporting. \n The U.S. EEOC stresses fairness in AI-based hiring, reinforcing the need for compliance-focused solutions.",
          },
          {
            id: 4,
            ...
            description:
              "Retention depends on visibility into workforce trends. \n With workforce management AI, organizations track performance, attendance, and engagement. \n SHRM highlights that analytics-driven planning leads to more resilient teams.",
          },
        ]}
      />
      ...
      <CustomerGrowthCards
        ...
        description="Every HR team has different needs, from recruitment to compliance. Our solutions are designed to support the full employee lifecycle, making HR operations more efficient, reliable, and employee-focused. Key solution areas include:"
        solutions={[
          {
            id: 1,
      ...
      <CustomerServiceCard
        ...
        description="Organizations comparing Workday AI HR agent features or an Oracle HR AI tools demo often find that our approach stands out through its focus on compliance, intelligence, and transformation, built for long-term HR success. Key differentiators include:"
        differentiators={[
          {
            id: 1,
      ...
      <CustomerBenefitSection
        ...
        heading="Hire Smarter, Onboard Faster, and Engage Better"
        description={["Reduce manual tasks, strengthen compliance, and improve employee support with solutions designed for real HR challenges.", "Whether you want to hire an AI HR virtual assistant, request an AI HR software demo, or deploy an AI HR agent today, our team is ready to help you move from process-heavy workflows to people-focused results."]}
        leftColumn={{
