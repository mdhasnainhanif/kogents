...
const page = () => {
  ...
  const pageData = {
    ...
    summary: {
      tag: "Summary",
      text: "Kogents AI empowers human resources with intelligent automation that transforms hiring, compliance, and engagement into one unified and data-driven experience."
  }
  };
  return (
    <>
