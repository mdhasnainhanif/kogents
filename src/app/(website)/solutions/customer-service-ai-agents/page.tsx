...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Cut response delays and reduce workload. Our customer service AI agent gives companies reliable automation with measurable ROI.',
    url: 'https://www.kogents.ai/solutions/customer-service-ai-agent', // replace with actual page URL
    type: 'website',
    images: [
      {
  ...
  return (
    <div>
      ...
      <CustomerBenefitSection
        ...
        description={[
          "Rising support volumes and high operational costs strain customer service teams. A customer service AI agent streamlines workflows, automates repetitive tasks, and ensures every customer gets timely, accurate help.",
          "With AI-powered support and conversational AI, you strengthen satisfaction while reducing overhead."
        ]}
        leftColumn={{
