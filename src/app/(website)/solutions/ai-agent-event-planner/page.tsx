...
export const metadata: Metadata = {
    title: 'AI Agent Event Planner for 100% Accuracy & Results | Kogents',
    description:
        ' Deploy #1 AI agent event planner to automate RSVPs, vendors, and guest experiences with efficiency while saving time, costs, and workload.',
    keywords: [],
    ...
    openGraph: {
        ...
        description:
            ' Deploy #1 AI agent event planner to automate RSVPs, vendors, and guest experiences with efficiency while saving time, costs, and workload.',
        url: 'https://www.kogents.ai/solutions/ai-agent-event-planner', // replace with actual page URL
        type: 'website',
        images: [
            {
    ...
    return (
        <>
            ...
            <CustomerBenefitSection
                ...
                description={["Manual planning drains time and increases errors. Now is the moment to hire an AI event planner that saves hours and simplifies execution. With the best AI event planning software, you can manage logistics and guests in real time without delays",
                    "For weddings, conferences, or corporate events, book an AI agent for event planning today and keep everything on schedule."]}
                leftColumn={{
