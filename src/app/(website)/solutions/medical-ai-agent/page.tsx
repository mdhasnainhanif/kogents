...
const page = () => {
    ...
    const pageData = {
        ...
        summary: {
            tag: "Summary",
            text: "Kogents AI empowers healthcare institutions with a compliant and explainable medical AI agent that enhances diagnostic precision and operational efficiency."
        }
    };
    return (
        <>
