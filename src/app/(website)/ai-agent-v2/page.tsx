...
aspect of being the most ‘complete’ chatbot platform.`}
              faqItems = {[
                ...
                },
                {
                  ...
                  image: "https://cdn.botpenguin.com/assets/website/icons/advanced-icon.svg",
                }
              ]}
          ...
          <CustomerBenefitSection
                ...
                leftColumn={{
                    ...
                    subtitle: "At BotPenguin, our highest priority is to provide maximum data security. We do not store any of your information ensuring all your data remains secure at all times.",
          ...
          >
            <WorkflowsSection />
            <section className="cv">
              <AIAgentSlider className="AiAgentNewSlider" />
            </section>
            <BenefitsSection
            ...
            cards={[ 
              { title: "Give chatbot your desired personality by adding brand tone, voice, and answer length", description: "" },
              { title: "Offer multi-language support for global reach", description: "" },
              { title: "Engage users with contextual conversations based on user interactions", description: "" },
              { title: "Train AI chatbot on multiple data sources - Docs, PDFs, Google Sheets, PPTs, Excel, and many more", description: "" },
            ]}
          /> 
            <AgentOSTwo />
            {/* <KogentBenefits /> */}
