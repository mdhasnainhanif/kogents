    ...
    return (
        <>
            ...
            <CustomerCards
                ...
                description="ealthcare providers face rising administrative pressure, growing patient demands, and strict regulatory requirements. A healthcare AI agent helps address these challenges with efficiency, compliance, and improved care delivery. Here’s how they help:"
                benefits={[
                    {
                        id: 1,
            ...
            <CustomerGrowthCards
                ...
                description="Educators and institutions require technology that not only supports learning but also simplifies teaching. An AI agent for education addresses these needs through solutions designed to enhance instruction, reduce workload, and improve accessibility. We offer:"
                solutions={[
                    {
                        id: 1,
            ...
            <CustomerServiceCard
                ...
                description="Selecting the right technology for classrooms requires more than features; it requires trust, compliance, and adaptability. Our AI agent for education is built on principles that ensure both effective learning outcomes and institutional confidence. That’s why we focus on:"
                differentiators={[
                    {
                        id: 1,
                ...
                faqItems={[
                    {
                        ...
                        image: "/assets/img/faq/education-step1.png",
                    },
                    {
                        id: 2,
                        q: "Deploy AI Agent",
                        ...
                        image: "/assets/img/faq/education-step2.png",
                    },
                    {
                        id: 3,
                        ...
                        image: "/assets/img/faq/education-step3.png",
                    },
                    {
                        id: 4,
                        ...
                        image: "/assets/img/faq/education-step4.png",
                    }
                ]}
            ...
            <CustomerBenefitSection
                ...
                description="Deploy an AI agent for education to increase engagement, personalize learning, and support ethical teaching practices. Our solutions are grounded in trusted research and designed to deliver measurable results institutions can rely on."
                leftColumn={{
