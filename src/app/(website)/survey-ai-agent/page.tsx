    ...
    return (
        <>
            ...
            <CustomerCards
                ...
                description="Surveys are often slowed by low responses and manual processes. A survey AI solution addresses these challenges with faster collection, smarter engagement, and reliable results.Here’s how they help:"
                benefits={[
                    {
                        id: 1,
            ...
            <CustomerServiceCard
                ...
                description="We design survey intelligence with a focus on accuracy, adaptability, and engagement. Each strength reflects how our approach makes data collection smarter, more reliable, and ready for real-world use.Here’s what sets us apart:"
                differentiators={[
                    {
                        id: 1,
            ...
            <FaqWithImage
                ...
                description="We follow a structured process to ensure surveys are efficient, accurate, and aligned with your goals. Each step focuses on improving feedback collection and delivering actionable Here's how it works:"
                faqItems={[
                    {
                        id: 1,
                        ...
                        image: "/assets/img/faq/survey-step1.png",
                    },
                    {
                        id: 2,
                        ...
                        image: "/assets/img/faq/survey-step2.png",
                    },
                    {
                        id: 3,
                        q: "Train & Integrate",
                        ...
                        image: "/assets/img/faq/survey-step3.png",
                    },
                    {
                        id: 4,
                        q: "Monitor & Optimize",
                        ...
                        image: "/assets/img/faq/survey-step4.png",
                    }
                ]}
            ...
            <CustomerBenefitSection
                tag="Healthcare Benefits"
                heading="Overcome slow response rates and inconsistent feedback."
                description="With a survey AI agent, you eliminate manual effort through an intelligent survey assistant that drives higher engagement and faster insights. Our AI-powered survey tool automates collection, enhances accuracy, and delivers results you can act on in real time."
                leftColumn={{
