...
const HealthCareCaseStudySection = () => {
  ...
  return (
    <div className="sectionPadding pb-0 bg-[url('../img/bc/revolutionize-bg.png')] bg-cover">
      <section className="sectionPaddingCase pt-0 pb_8 mobile-padding-bottom-0 scrollSectionInner">
              ...
              <div className="col-xl-5 col-lg-12 col-md-12">
                <div className="px-md-3 rounded scroll2 right-column hideOnipad">
                  ...
                  <div className="d-flex align-items-start mt-2">
                    <div
                      className="d-flex nav flex-column nav-pills me-3"
                      id="v-pills-tab"
                      role="tablist"
                  ...
                  <div className="col-12 text-center mt-4">
                    <button
                      className="buttonAnimation2 flex justify-center green items-center gap-2 mt-4 px-6 py-[.875rem] rounded-full border btn-border text-base font-medium bg-gd-secondary text-w-900 width_fit open-modal-btn text-light"
                      onClick={openModal}
                    >
                      Request Demo
                      <Image 
