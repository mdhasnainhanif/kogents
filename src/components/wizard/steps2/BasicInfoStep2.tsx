              ...
              <AnimatePresence>
                ...
                >
                  <div className="chatbot-content">
                    <div className="mb-4">
                      <div>Step 1 of 4</div>
                      <h3 className="text-white">Welcome to Kogents</h3>
                    ...
                    <div className="mb-3">
                      ...
                      <div className="custom_select">
                        <select
                          ...
                          value={data.role || ""}
                          onChange={(e) =>
                            onUpdate({ role: e.target.value as ChatbotWizardData["role"] })
                          }
                        >
                          ...
                          <option value="ecommerce-category-manager">E-commerce Category Manager</option>
                          <option value="itsm-manager">ITSM Manager</option>
