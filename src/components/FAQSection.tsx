...
const FAQ_ITEMS: Faq[] = [
  ...
  },
  {
    ...
    a: "AI agents respond dynamically to user input, assisting with tasks such as form filling, answering questions, and processing requests based on the AI's understanding of the user’s intent.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes, you can customize your AI Agent’s behavior, appearance, and response style to align with your brand and operational needs.",
  },
  {
  ...
  },
  {
    ...
    a: "AI Agents use advanced language models, such as OpenAI’s GPT-4, to provide intelligent, human-like responses.",
  },
  {
  ...
  },
  {
    ...
    a: "You can easily modify your AI Agent’s behavior, responses, and settings through the management dashboard.",
  },
  {
...
const FaqSection: React.FC = () => {
  ...
  const hasMore = visibleCount < FAQ_ITEMS.length;
    ...
    >
      <div className="container px-5 mx-auto xl:px-0">
        <div className="flex flex-col items-center justify-center">
          ...
          >
            Frequently Asked <span className="inline-block lg:block"></span>
            Questions
          </h2>
            ...
            {hasMore ? (
              <div>
                <button
                  type="button"
                  onClick={() =>
                    setVisibleCount((c) => Math.min(c + CHUNK, FAQ_ITEMS.length))
                  }
