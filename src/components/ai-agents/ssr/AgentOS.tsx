                ...
                <div className="rainbowImage">
                    <div className="row">
                        <div className="col-md-4">
                            <div className="img1">
                                ...
                                <div className="bothImgMain">
                                    <Image loading="lazy" src="/assets/img/t1.png" alt="" width={80} height={80} />
                                    <Image loading="lazy" className="boxSvg" src="/assets/img/box-01.svg" alt="" width={800} height={600} />
                                    <p className="boxSvgText">Email Triage Ai Agent</p>
                                </div>
                            </div>
                            <div className="img2">
                                <div className="bothImgMain">
                                    <Image loading="lazy" src="/assets/img/t2.png" alt="" width={80} height={80} />
                                    <Image loading="lazy" className="boxSvg" src="/assets/img/box-01.svg" alt="" width={800} height={600} />
                            ...
                            <div className="img3">
                                <div className="bothImgMain">
                                    <Image loading="lazy" src="/assets/img/t3.png" alt="" width={80} height={80} />
                                    <Image loading="lazy" className="boxSvg" src="/assets/img/box-01.svg" alt="" width={800} height={600} />
                        ...
                        <div className="col-md-4 d-flex align-items-center justify-content-center">
                            <div className="img4">
                                <div className="bothImgMain">
                                    <Image loading="lazy" src="/assets/img/t4.png" alt="" width={80} height={80} />
                                    <Image loading="lazy" className="boxSvg" src="/assets/img/box-01.svg" alt="" width={800} height={600} />
                        ...
                        <div className="col-md-4">
                            <div className="img5">
                                <div className="bothImgMain">
                                    <Image loading="lazy" src="/assets/img/t5.png" alt="" width={80} height={80} />
                                    <Image loading="lazy" className="boxSvg" src="/assets/img/box-01.svg" alt="" width={800} height={600} />
                            ...
                            <div className="img6">
                                <div className="bothImgMain">
                                    <Image loading="lazy" src="/assets/img/t6.png" alt="" width={80} height={80} />
                                    <Image loading="lazy" className="boxSvg" src="/assets/img/box-01.svg" alt="" width={800} height={600} />
                            ...
                            <div className="img7">
                                <div className="bothImgMain">
                                    <Image loading="lazy" src="/assets/img/t7.png" alt="" width={80} height={80} />
                                    <Image loading="lazy" className="boxSvg" src="/assets/img/box-01.svg" alt="" width={800} height={600} />
