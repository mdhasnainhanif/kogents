...
const CTAModal = () => {
  ...
  return (
    <div
      ...
      className={`
        fixed top-0 left-0 z-[9999] w-full h-full flex items-center justify-center
          ...
          <div className="col-md-6 p-md-0">
            <div className="home_modal_bg">
              <div className="section-heading mt-2">
                ...
                <img className="modalPhoneImg" src="/assets/img/robo.webp" alt="Robot" />
              </div>
            </div>
          </div>
              ...
              <div className="form2">
                <form id="contact_form" onSubmit={handleSubmit}>
                  <h2 className="bookConsultation modalBookFree">
                    <span className="textGray">Book Your</span> Free<br /> Consultation
                  </h2>
