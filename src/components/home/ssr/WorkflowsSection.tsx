...
export default function WorkflowsSection() {
  return (
    <section className="sectionPadding bg-center bg-no-repeat bg-cover bg-[url('../img/bc/FAQ-bg.png')]">
      <div className="container paddingOnMobile">
        <div className="row justify-content-center">
          <div className="col-md-8">
            ...
            <p className="maxWidth39 mb-16 text-center paraColor subHeading text-center mx-auto">
