...
export default function WorkflowsSection() {
  return (
    <section
    className="sectionPadding bg-center bg-no-repeat bg-cover bg-[url('../img/bc/FAQ-bg.png')]"
  >
        ...
        <div className="col-lg-11 d-flex flex-column justify-content-center">
          <div className="row">
            <div className="col-md-3 d-flex justify-content-center align-items-center">
              <div
                className="d-flex flex-column align-items-end position-relative marginZeroMobile wfullMobile"
              ...
              >
                    ...
                    >
                      <defs>
                        <radialGradient id="b" cx=".5" cy=".5" r=".5">
                          <stop offset="0%" stopColor="#fff" stopOpacity=".7"></stop>
                        ...
                        >
                          ...
                          <stop offset="100%" stopColor="#6d63a7" stopOpacity=".2"></stop>
                        </linearGradient>
                      </defs>
                      <path stroke="url(#a)" strokeWidth="4" d="M0 10h300"></path>
                ...
                <div className="googleFeatureBtn ml-auto">
                  ...
                  <p>
                    Sorts, syncs, and surfaces your files using smart tagging and
                    instant recall.
                  </p>
                </div>
                <div
              ...
              <div>
                <div className="d-flex gap-3 justify-content-center position-relative flexColumnOnIpad">
                    ...
                    >
                      ...
                      <defs>
                        ...
                        >
                          ...
                          <stop offset="1" stopColor="#6d63a7" stopOpacity="0.14"></stop>
                        </linearGradient>
                      </defs>
                      <animate
                  ...
                  <div className="googleFeatureBtn">
                    ...
                    <p>
                      Drafts, replies, and declutters your inbox with Al-powered
                      message control.
                    </p>
                  </div>
                      ...
                      >
                        <defs>
                          ...
                          >
                            ...
                            <stop offset="100%" stopColor="#6d63a7" stopOpacity=".2" />
                          </linearGradient>
                        </defs>
                        <path stroke="url(#a)" strokeWidth="4" d="M10 0v450" />
                  ...
                  <div className="googleFeatureBtn ml-auto">
                    ...
                    <p>
                      Captures, organizes, and updates pages with smart prompts
                      and task logic.
                    </p>
                  </div>
                  <div
                ...
                <div className="d-flex gap-3 justify-content-center position-relative mb-md-0 mb-5">
                      ...
                      >
                        <defs>
                          ...
                          <linearGradient
                            ...
                            gradientUnits="userSpaceOnUse"
                          >
                            <stop offset="0%" stopColor="#332f4b" stopOpacity=".2" />
                  ...
                  <div className="googleFeatureBtn mt-0">
                    ...
                    <p>
                      Finds routes, flags delays, and auto-suggests places with
                      smart tracking.
                    </p>
                  </div>
                  <div
                  ...
                  <div className="googleFeatureBtn ml-auto mt-0">
                    ...
                    <p>
                      Sorts emails, schedules meetings, and adds reminders with
                      contextual Al.
                    </p>
                  </div>
                </div>
            ...
            <div className="col-md-3 d-flex flex-column justify-content-center">
              <div className="stepBoxMain">
                <div className="stepBox position-relative">
                  <div
                    className="newLineAnimation showOnMobile"
                    style={{
                      position: "absolute",
                      zIndex: -1,
                      top: "-48px",
