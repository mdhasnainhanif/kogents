        ...
        <div className="container">
          ...
          <div className="row rowGap justify-content-center mt-4">
            ...
            <div className="col-xl-6 col-lg-6 col-md-6 col-12">
              ...
              >
                ...
                <ul className="arrowPointUl">
                  ...
                  <li>
                    Learns from ongoing customer behavior and flags issues in real
                    time.
                  </li>
                  <li>
            ...
            <div className="col-xl-6 col-lg-6 col-md-6 col-12">
              ...
              >
                ...
                <ul className="arrowPointUl">
                  ...
                  <li>
                    Recognizes and logs recurring issues from voice interactions.
                  </li>
                  <li>
                    Automatically generates and updates knowledge base entries for
            ...
            <div className="col-lg-12 col-md-6 col-12 card_hide_ipadpro">
              <div
                className="p-6 border rounded-lg border-b-600 bg-gd-tertiary aos-init aos-animate newServicesCard newServicesCard1"
              >
                    ...
                    <div>
                      <div>
                        ...
                        <ul className="arrowPointUl">
                          ...
                          <li>
                            Detects customer drop-offs and friction points in the
                            purchase journey.
                          </li>
                          <li>
            ...
            <div className="col-xl-4 col-lg-6 col-md-6 col-12">
              ...
              >
                ...
                <ul className="arrowPointUl">
                  <li>
                    Works independently in browser or app — no integration needed.
                  </li>
            ...
            <div className="col-xl-4 col-lg-6 col-md-6 col-12">
              ...
              >
                ...
                <ul className="arrowPointUl">
                  ...
                  <li>
                    Tracks real-world visitor questions and highlights common gaps
                    in service or signage.
                  </li>
                  <li>
                    Improves in-person experience while reducing staff dependency.
                  </li>
                </ul>
          ...
          <div className="row rowGap justify-content-center mt-4">
            <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
              ...
              >
                ...
                <ul className="arrowPointUl">
                  <li>
                    Instantly deliver answers by linking agents to your knowledge
                    base
                  </li>
                  <li>
                  ...
                  <li>
                    Automatically generate FAQs using previous ticket resolutions
                  </li>
                </ul>
                <Link
                  href="#"
                    ...
                    <div>
                      <div>
                        ...
                        <ul className="arrowPointUl">
                          ...
                          <li>
                            Creates automated FAQs from completed customer service
                            chats and returns
                          </li>
                        </ul>
                        <div className="button-center-ipad">
            ...
            <div className="col-xl-4 col-lg-6 col-md-6 col-sm-6">
              ...
              >
                ...
                <ul className="arrowPointUl">
                  ...
                  <li>
                    Spot patterns in customer chats to highlight recurring issues
                  </li>
            ...
            <div className="col-xl-4 col-lg-6 col-md-6 col-sm-6">
              ...
              >
                ...
                <ul className="arrowPointUl">
                  <li>
                    Works independently to answer customer questions in real-time
                  </li>
                  <li>
                    Monitors support trends to recommend product or service tweaks
                  </li>
                  <li>
                    Learns from past tickets to keep your FAQs fresh and relevant
                  </li>
                </ul>
                <Link
                  href="#"
            ...
            <div className="col-xl-4 col-lg-6 col-md-6 col-sm-6">
              ...
              >
                ...
                <ul className="arrowPointUl">
                  <li>
                    Provides quick answers to visitors via interactive touchscreen
                    kiosks
                  </li>
                  <li>
                    Analyzes in-store queries to uncover service gaps or friction
                    points
                  </li>
                  <li>
