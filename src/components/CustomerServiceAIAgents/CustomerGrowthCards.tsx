...
const CustomerGrowthCards: React.FC<CustomerGrowthCardsProps> = ({
  ...
  description = [
    "Delivering exceptional support requires solutions that reduce workload, improve accuracy, and adapt to customer needs.",
    "Our range of customer service AI agent offerings is designed to address these priorities with advanced automation and personalized assistance."
  ],
  solutions = [
    {
      id: 1,
      ...
      description: [
        "Deploy virtual customer service AI agents built on conversational AI and NLP.",
        "They efficiently handle FAQs, ticketing, and complex queries, ensuring customers receive timely and accurate responses across every channel."
      ]
    },
    {
      id: 2,
      ...
      description: [
        "Reduce manual tasks with intelligent customer support agents that automate ticket creation, CRM integration, and customer sentiment analysis.",
        "This allows teams to focus on critical issues while maintaining consistency in daily operations."
      ]
    },
    {
      id: 3,
      ...
      description: [
        "Deliver context-aware recommendations and tailor every interaction with personalization features.",
        "When needed, queries are escalated to human agents, creating a balanced hybrid AI + human service model that builds trust and satisfaction."
      ]
    },
    {
      id: 4,
                ...
                <div key={solution.id} className="col-lg-6 col-md-6 mb-4">
                  <div className="solutionCard border border-b-600 bg-gd-tertiary p-4 rounded-lg h-100">
                    ...
                    <div className="d-flex justify-content-between flexReverse">
                      ...
                      <div className="text-white mb-4 paraColor">
