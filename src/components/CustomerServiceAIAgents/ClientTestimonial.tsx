      ...
      <div className="container clientTestimonialSection">
        <div className="row justify-content-center">
          <div className="col-lg-10 text-center">
            {/* Tag */}
            <span className="buttonAnimation purple inline-block px-4 py-2 text-sm font-medium border rounded-full border-blue-400 bg-b-600 text-tropical-indigo mb-6">
              {tag}
            </span>
